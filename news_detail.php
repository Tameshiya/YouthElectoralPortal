...
<body>
              ...
              <div class='row'>
                  <div class='col-md-12'>
                     <ul id="menu-%d0%b3%d0%bb%d0%b0%d0%b2%d0%bd%d0%be%d0%b5-%d0%bc%d0%b5%d0%bd%d1%8e" class="">
                       <li id="menu-item-31" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-20"><a href="/">Главная</a></li>
  ...
  <?php
  $jsonurl = "http://127.0.0.1:8081/news/".$_GET['id'];
  $json = file_get_contents($jsonurl);
  $result = json_decode($json, true);
  echo '<h1 class="category-head">'.$result['title'].'</h1></div><div class="col-sm-4">
  <p class="breadcrumbs"><span class="white-bg-spn"><a href="index.php">Главная</a>  /  Новости</span></p></div></div>
  <div style="margin-bottom:32px;">'.$result['date'].'</div>';
