...
<body>
              ...
              <div class='row'>
                  <div class='col-md-12'>
                     <ul id="menu-%d0%b3%d0%bb%d0%b0%d0%b2%d0%bd%d0%be%d0%b5-%d0%bc%d0%b5%d0%bd%d1%8e" class="">
                      ...
                      <li id="menu-item-20" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-20"><a href="abount.php">О мик</a></li>
                      ...
                      <li id="menu-item-217" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-30 current_page_item menu-item-31"><a href="partners.php">Партнеры</a></li>
  ...
  <div class="row category-header">
    <div class="col-sm-8">
            <h1 class="category-head">Партнеры</h1>
    </div>
    <div class="col-sm-4">
      <p class="breadcrumbs"><span class="white-bg-spn"><a href="index.php">Главная</a>  /  Наши партнеры</span></p>
    </div>
  </div>
	<ul class="meth list gap1">
		<li><a href="http://minobr.nso.ru/Pages/default.aspx"> <span style="font-size: 13px;">Министерство образования Новосибирской области</span></a> <br>
 <br>
 </li>
		<li><a href="http://mk.nso.ru/"><span style="font-size: 13px;"> Министерство культуры Новосибирской области</span></a> <br>
 <br>
 </li>
		<li><a href="http://minregion.nso.ru/"><span style="font-size: 13px;"> Министерство региональной политики Новосибирской области</span></a> <br>
 <br>
 </li>
		<li><a href=" http://www.altai_terr.izbirkom.ru/"><span style="font-size: 13px;">Избирательная комиссия Алтайского края</span></a> <br>
 <br>
 </li>
	</ul>
  </section>
