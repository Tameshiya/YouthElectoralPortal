...
<body>
              ...
              <div class='row'>
                  <div class='col-md-12'>
                     <ul id="menu-%d0%b3%d0%bb%d0%b0%d0%b2%d0%bd%d0%be%d0%b5-%d0%bc%d0%b5%d0%bd%d1%8e" class="">
                      ...
                      <li id="menu-item-31" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-20"><a href="/resources/">Новости</a></li>
                      ...
                      <li id="menu-item-1224" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-30 current_page_item menu-item-31"><a href="contacts.php">Контакты</a></li>
  ...
  <div class="row category-header">
    <div class="col-sm-8">
            <h1 class="category-head">Контакты</h1>
    </div>
    <div class="col-sm-4">
      <p class="breadcrumbs"><span class="white-bg-spn"><a href="index.php">Главная</a>  /  контакты</span></p>
    </div>
  </div>
  <div class="row">
    <div class="col-md-6">
    <h3>Молодежная избирательная комиссия<br> Новосибирской области</h3>
    <p><strong>Адрес:</strong> Новосибирск, Красный проспект, д.18</p>
    <p><strong>Телефон:</strong>(383) 223-46-31</p>
    <p><strong>Email:</strong>infc@nso.ru</p>
    <p><strong>Факс:</strong>227-02-57</p>
    </div>
  </div>
  </section>
  <footer>
