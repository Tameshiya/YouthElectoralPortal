              ...
              <div class='row'>
                  <div class='col-md-12'>
                     <ul id="menu-%d0%b3%d0%bb%d0%b0%d0%b2%d0%bd%d0%be%d0%b5-%d0%bc%d0%b5%d0%bd%d1%8e" class="">
                      ...
                      <li id="menu-item-854" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-30 current_page_item menu-item-31"><a href="feedback.php">Обратная связь</a></li>
  ...
  <section>
    <div style="margin-bottom:150px;" class="container">
      <div class="row category-header">
        <div class="col-sm-8">
          <h1 class="category-head">Обратная связь</h1>
        </div>
        <div class="col-sm-4">
          <p class="breadcrumbs"><span class="white-bg-spn"><a href="index.php">Главная</a>  /  Обратная связь</span></p>
        </div>
      </div>
      <form action="feedbackHandler.php" method="post">
        <fieldset id="candidates">
          <div><label for="name">Имя: </label><input name="name" type="text" id="name"></div>
          <div><label for="email">Email: </label><input name="email" type="email" id="email"></div>
          <div><label for="text">Ваш вопрос: </label><textarea style="max-height: 200px;" rows="10" cols="45" name="text" id="text"></textarea></div>
          <input type="submit" style="margin:16px;">
        </fieldset>
      </form>
      <br>
      <p style="color:#FF0000;">* Все поля обязательны для заполнения</p>
    </div>
  </section>
  <footer>
